...
LOG_FILE_NAME = "E:\\GisPython\\logs\\ImportRoadAlarm.log"
...
if __name__ == '__main__':
    try:
        ...
        intable = ArcCatalogPath+"\\"+DataSourcePath+"\\WANGYOU.F_RAILWAY_ALARM"
        alarmPoints = ArcCatalogPath+"\\"+GISDBPath+"\\WangYouSite.DBO.GIS_IMPORTROAD_ALARM"
        ...
        deleteSql = "delete from [WangYouSite].[dbo].[GIS_IMPORTROAD_ALARM]"
